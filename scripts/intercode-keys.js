const INTERCODE_KEYS = {
    ...
    NOT_FRONT_IS_FULL:'NOT_FRONT_IS_FULL',
    NEXT_TO_SON:'NEXT_TO_SON' ,
    NOT_NEXT_TO_SON:'NOT_NEXT_TO_SON',
    NEXT_TO_FATHER:'NEXT_TO_FATHER' ,
    NOT_NEXT_TO_FATHER:'NOT_NEXT_TO_FATHER', 
    NEXT_TO_DESCENDANT:'NEXT_TO_DESCENDANT',
    NOT_NEXT_TO_DESCENDANT:'NOT_NEXT_TO_DESCENDANT'
